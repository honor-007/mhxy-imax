...
from game_common_action.game_mouse import client_lock_mouse_move, move_click_with_fight, move_with_fight, left_click, \
    right_click, release
...
if __name__ == '__main__':
    ...
    def randomMove():
        while True:
            game_mouse.move(random.randint(100, 700), random.randint(100, 600))
