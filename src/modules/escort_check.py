...
def click_move_word(rectangle):
    ...
    """
    print(rectangle)
    game_mouse.move(rectangle[0][0] - 30, rectangle[0][1] - 30)
    ...
    game_mouse.move_click(click_x, click_y, bias=5)
    game_mouse.move(100 - random.randint(20, 70), 100 - random.randint(20, 70))
    # utils.move(rectangle[0][0] - 30, rectangle[0][1] - 30)
